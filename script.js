...
function increaseScore() {
  score++;
  if (score === q) {
    const p1 = document.getElementById('s').innerText;
    const p2 = document.getElementById('l').innerText;
    const p4 = document.getElementById('t').innerText;
    const e= p1 + p2 + p3 + p4 + p5;
    const f= atob(e);
    alert(f);
  }
